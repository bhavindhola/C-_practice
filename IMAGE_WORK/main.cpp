...
int main(int argc, char *argv[])
{
    ...
    int r, c;
    // read image header
    readImageHeader("Lenna_standard.pgm", N, M, Q, type);
    ...
    Image secImage(image);
        // read image
    readImage("Lenna_standard.pgm", image);
    ...
    while(choice > 0 && choice <= 13)
    {
                ...
                switch(choice)
        {
            ...
            case 8: //mean gray
                ...
                break;
            case 12:   //add
                 readImageHeader("newimage.pgm", N, M, Q, type);

                // allocate memory for the image array
                secImage.setImageInfo(N, M, Q);

                // read image
                readImage("newimage.pgm", secImage);
